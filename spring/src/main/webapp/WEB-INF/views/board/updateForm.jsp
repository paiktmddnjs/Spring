...
<body>
	...
	<div class="board-container">
		<div class="board-card">
			...
			<form action="${pageContext.request.contextPath}/update.bo?boardNo=${board.boardNo}" method="post" enctype="multipart/form-data">
				<table class="form-table">
					...
					<tr>
						<th>내용</th>
						<td><textarea name="content" rows="10">${board.boardContent}</textarea>
						</td>
					</tr>
					<tr>
						<th>첨부파일</th>
